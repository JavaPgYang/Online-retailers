    ...
    <div class="toolbar-wrap J-wrap">
        <div class="toolbar">
            <div class="toolbar-panels J-panel">
                ...
                <div style="visibility: hidden;" class="J-content toolbar-panel tbar-panel-cart toolbar-animate-out">
                    <h3 class="tbar-panel-header J-panel-header">
                        ...
                        <span class="close-panel J-close" onclick="cartPanelView.tbar_panel_close('user');"></span>
                    </h3>
                            ...
                            <div class="jt-history-wrap">
                                <ul>
                                    <!--<li class="jth-item">
                                        ...
                                        <a class="add-user-button" href="#" target="_blank">加入购物车</a>
            ...
            <div class="toolbar-tabs J-tab">
                <div onclick="cartPanelView.tabItemClick('user')" class="toolbar-tab tbar-tab-cart" data="购物车"
                     tag="cart">
                    <i class="tab-ico"></i>
